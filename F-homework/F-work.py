...
def homepage():
    ...
    url4 = '<a href="/help">帮助</a><br>'
    url5 = '<a href="/ScoreChart">OSU得分前十统计表</a><br>'
    url6 = '<a href="/AverageScorePicture">OSU得分前十平均得分条形图</a><br>'
    end = '</center></body></html>'
    print("当前正在访问主页")
    return start+url1+url2+url3+url5+url6+url4+end
